...
- [ ] Update `shared/icons/README.md` with full icon inventory
...
mkdir -p shared/components/templates/simple
mkdir -p shared/components/templates/interactive
mkdir -p shared/components/templates/complex
```

**Files to create**:
- `shared/components/templates/README.md` — Template usage guide
- `shared/components/templates/template.html` — Base template with common includes
...
**For each component**:
- [ ] Create `shared/components/templates/simple/{component-name}.html`
...
**Approach**:
Create `shared/components/index.html` as a living catalog:
...
2. **Create the template**
   - Use `shared/components/templates/template.html` as base
...
4. **Update the gallery**
   - Add to `shared/components/index.html`
...
- **Component Docs**: `shared/components/ELEVATE_COMPONENTS.md`
- **Demo Page**: `shared/components/elevate-demo.html`
