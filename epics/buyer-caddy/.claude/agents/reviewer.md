...
3. Exclude task tracking files from diff:
   - `docs/requirements/*/task-*.md` - task tracking files

**Why branch-scoped?** Comparing against the base branch shows the actual feature work.
...
- **Every new user-facing feature must have end-to-end tests.** Missing e2e coverage for a new feature is a **Critical** finding.
...
3. Example: `docs/requirements/features/ready-to-implement/my-feature/review-01.md`
